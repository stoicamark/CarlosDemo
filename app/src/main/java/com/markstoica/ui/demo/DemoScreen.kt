    ...
    Scaffold(
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                supportingText = {
                    Text(text = uiState.usernameErrorRes?.let { stringResource(it) }.orEmpty())
                },
            ...
            OutlinedPasswordTextField(
                ...
                supportingText = {
                    Text(text = uiState.passwordErrorRes?.let { stringResource(it) }.orEmpty())
                },
                modifier = Modifier.fillMaxWidth(),
            )
            ...
            OutlinedPasswordTextField(
                ...
                supportingText = {
                    Text(text = uiState.confirmPasswordErrorRes?.let { stringResource(it) }.orEmpty())
                },
                modifier = Modifier.fillMaxWidth(),
            )
